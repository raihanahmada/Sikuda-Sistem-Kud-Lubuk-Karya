    ...
    return (
        <div className="form-control w-full">
            <label className="label py-1.5">
                <span className="label-text text-base font-medium text-base-content/80">{label}</span>
            </label>
            ...
            {error ? (
                <label className="label py-1">
                    <span className="label-text-alt text-error text-sm font-medium">{error}</span>
                </label>
            ) : hint ? (
                <label className="label py-1">
                    <span className="label-text-alt text-base-content/50 text-sm">{hint}</span>
                </label>
            ) : null}
        </div>
    );
...
export default function Pengaturan() {
    ...
    const handleSaveProfile = () => {
        ...
        profileForm.post(route('admin-anggota.pengaturan.update'), {
            preserveScroll: true,
    ...
    const handleSavePassword = () => {
        ...
        passwordForm.post(route('admin-anggota.pengaturan.update'), {
            preserveScroll: true,
            onSuccess: () => {
                closePasswordModal();
                ...
                <div className="card bg-white border border-base-200/60 shadow-xl shadow-base-200/40 rounded-2xl">
                    <div className="card-body p-6 sm:p-8">
                        <div className="flex items-center gap-3 border-b border-base-200/60 pb-4 mb-6">
                            ...
                            <h2 className="text-xl font-bold text-base-content">Informasi Akun</h2>
                        </div>
                        ...
                        <div className="flex flex-col sm:flex-row gap-8 items-start">
                            ...
                            <div className="w-full space-y-4">
                                <div className="form-control w-full">
                                    <label className="label py-1.5">
                                        <span className="label-text text-base font-medium text-base-content/80">Nama Pengguna</span>
                                    </label>
                                    <input
                                        type="text"
                                    ...
                                    {profileForm.errors?.nama_pengguna && (
                                        <label className="label py-1">
                                            <span className="label-text-alt text-error text-sm font-medium">
                                                {profileForm.errors.nama_pengguna}
                                            </span>
                                        </label>
                                    )}
                                ...
                                <div className="form-control w-full">
                                    <label className="label py-1.5">
                                        <span className="label-text text-base font-medium text-base-content/80">Role Pengguna</span>
                                    </label>
                                    <div>
                                        <span className="badge badge-outline badge-lg gap-2 px-4 py-3 rounded-xl border-green-700/30 bg-green-700/5 font-semibold text-sm">
                                            <Shield size={16} />
                                            {auth?.user?.role || "-"}
                                        </span>
                                    </div>
                        ...
                        <div className="flex justify-end mt-8 pt-4 border-t border-base-200/60">
                            <button
                                ...
                                className="btn text-white bg-gradient-to-r from-green-700 to-green-800 hover:from-green-800 hover:to-green-900 border-none shadow-lg shadow-green-700/30 rounded-xl px-8 py-2.5 text-base font-medium transition-all duration-300 hover:scale-[1.02] disabled:opacity-70 disabled:hover:scale-100"
                            >
                    ...
                    <div className="card-body p-0">
                        <div className="p-6 sm:p-8">
                            <div className="flex items-center gap-3 border-b border-base-200/60 pb-4 mb-2">
                                ...
                                <h2 className="text-xl font-bold text-base-content">Keamanan Akun</h2>
                            </div>
                        </div>
                            ...
                            >
                                <div className="flex items-center gap-4">
                                    <div className="w-12 h-12 rounded-2xl bg-green-700/10 flex items-center justify-center group-hover:scale-110 group-hover:bg-green-700/20 transition-all duration-300">
                                        <Lock size={24} className="text-green-800" />
                                    </div>
                                    <div className="text-left">
                                        <p className="text-lg font-bold text-base-content">Ubah Password</p>
                                        <p className="text-base text-base-content/60 mt-0.5">Tingkatkan keamanan dengan kata sandi baru</p>
                                    </div>
                                </div>
                    ...
                    <div className="card-body p-6 sm:p-8">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div className="bg-base-100 p-4 rounded-xl border border-base-200/60 shadow-sm flex flex-col gap-1">
                                <p className="text-sm text-base-content/50 font-medium">Nama Sistem</p>
                                <p className="text-base font-bold text-base-content">Sistem Informasi KUD Lubuk Karya</p>
                            </div>
                            <div className="bg-base-100 p-4 rounded-xl border border-base-200/60 shadow-sm flex flex-col gap-1">
                                <p className="text-sm text-base-content/50 font-medium">Versi</p>
                                <p className="text-base font-bold text-base-content">v1.0.0 (Release)</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <dialog ref={passwordModalRef} className="modal" onClose={resetPasswordForm}>
                <div className="modal-box relative bg-white border border-base-200/60 shadow-2xl rounded-3xl p-6 sm:p-8">
                    ...
                    <div className="flex items-center gap-3 mb-6">
                        ...
                        <div>
                            <h3 className="font-extrabold text-2xl">Ubah Password</h3>
                            <p className="text-sm text-base-content/60 font-medium mt-0.5">Pastikan gunakan kata sandi yang kuat</p>
                        </div>
                    </div>
                    ...
                    <div className="modal-action mt-8 pt-4 border-t border-base-200/60 gap-3">
                        <button
                            ...
                            className="btn btn-ghost rounded-xl text-base font-medium"
                        >
                            Batal
                        </button>
                        <button
                            ...
                            className="btn text-white bg-gradient-to-r from-green-700 to-green-800 hover:from-green-800 hover:to-green-900 border-none shadow-lg shadow-green-700/30 rounded-xl px-8 py-2.5 text-base font-medium transition-all duration-300 disabled:opacity-70"
                        >
