...
export default function Show({ anggota }) {
    ...
    // Form Inertia untuk mengirim alasan penolakan ke Laravel
    ...
    return (
        <AdminAnggotaLayout title="Detail Verifikasi">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                {/* DATA CALON ANGGOTA SESUAI DPPL */}
                ...
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 h-fit">
                    ...
                    {!tampilFormTolak ? (
                        <div className="space-y-3">
                            ...
                            <button
                                onClick={() => setTampilFormTolak(true)}
                        ...
                        /* FORM ALASAN PENOLAKAN (Sesuai kolom alasan_penolakan di DPPL) */
                        <form onSubmit={handleTolakSubmit} className="space-y-4">
                            ...
                            <div className="flex space-x-2">
                                ...
                                <button
                                    type="button"
                                    onClick={() => setTampilFormTolak(false)}
